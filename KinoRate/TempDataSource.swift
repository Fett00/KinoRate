...
class KinoData{
    ...
    private var v1 = ["Форсаж","Начало","Довод","Тайна Коко","Голодные Игры","Превый","Второй","Четвертый","Пятый","Седьмой","ШЕстой","Первыв"]
    ...
    private var v3 = ["Петя Петров","Иван Иванов","Аркадий Аркадиев","Ибрагим Ибрагимов","Сейт Сейтович","Кирилл Кириллов","Никита Никитин","Лер Леров","Дарий Дариев","Владислав Владиславович","Даниил Даниилов"]
}
